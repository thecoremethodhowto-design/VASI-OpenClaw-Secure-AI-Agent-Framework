...
# ── ACCESS KATMANI (DACE) ─────────────────────────────────────────────────────
# Yetkilendirme, siniflandirma ve guvenlik kontrolleri access.py icinde.
# Testlerde bu isimleri patch'lemek icin `vasi.access` uzerinden gidin.
import access
from access import (
    ALLOWED_TOOL_NAMES,
